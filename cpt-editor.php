						...
						<th scope="row">
							<label for="<?php echo ( $label_name ); ?>">
								...
								if ( 'description' == $label_name ) {
									...
									printf( __( '%1$1s<br />(%2$2s)', 'cpt-editor' ), esc_html( $label_info['name'] ), esc_html( $label_name ) );
								}
								?>
							</label></th>
						<td>
							...
							?>
							<span class="description"><?php printf( __( '%1$1s Default: %2$2s', 'cpt-editor' ), esc_html( $label_info['description'] ), $default ); ?></span>
						</td>
					</tr>
					<?php
				}
